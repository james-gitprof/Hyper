...
public class MapActivity extends AppCompatActivity {
    ...
    private final LocationObserver locationObserver = new LocationObserver() {
        ...
        public void onNewLocationMatcherResult(@NonNull LocationMatcherResult locationMatcherResult) {
            android.location.Location location = locationMatcherResult.getEnhancedLocation();
    ...
    private void updateCamera(Point point, Double bearing) {
        ...
        CameraOptions cameraOptions = new CameraOptions.Builder().center(point)
                .zoom(18.0).bearing(bearing).pitch(45.0)
                .padding(new EdgeInsets(1000.0, 0.0, 0.0, 0.0)).build();
        Toast.makeText(MapActivity.this, "Updating camera", Toast.LENGTH_SHORT).show();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        myLocationButton = findViewById(R.id.fabMyLocation);

        setRoute = findViewById(R.id.btnSetRoute);
